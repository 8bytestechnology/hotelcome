...
function sort(countries: GuestModel[]): GuestModel[] {
  // if (direction === '') {
    return countries;
  // } else {
...
//function matches(country: GuestModel, term: string, pipe: PipeTransform) {
//  return country.name.toLowerCase().includes(term.toLowerCase())
//    || country.tag.toLowerCase().includes(term.toLowerCase())
...
export class GuestService {
  ...
  private _countries$ = new BehaviorSubject<GuestModel[]>([]);
